...
category: []
created: '2023-05-30T22:12:41.639781'
license: ''
...
- description: null
  format: JSON
  name: Esri Rest API
  url: https://arcgis.dvrpc.org/portal/rest/services/Transportation/CMP2019_PA_CrashFrequencySeverity/FeatureServer/0
- description: null
  format: GeoJSON
  name: GeoJSON
  url: https://arcgis.dvrpc.org/portal/rest/services/Transportation/CMP2019_PA_CrashFrequencySeverity/FeatureServer/0/query?where=1=1&outsr=4326&outfields=*&f=geojson
- description: null
  format: HTML
  name: DVRPC GIS Catalog
  url: https://dvrpc-dvrpcgis.opendata.arcgis.com/datasets/dvrpcgis::cmp-2019-pennsylvania-crash-frequency-and-severity-analysis
- description: null
  format: XML
  name: Metadata XML
  url: https://arcgis.dvrpc.org/dvrpc/sharing/rest/content/items/1d3376d26d9c4a26ab62d4c3f9a8c728/info/metadata/metadata.xml?format=default
- description: V:\Transportation\Transportation.sde\gis.Transportation.CMP2019_PA_CrashFrequencySeverity
...
tags: []
time_period: null
title: CMP 2019 Pennsylvania Crash Frequency and Severity Analysis
usage: null
---
